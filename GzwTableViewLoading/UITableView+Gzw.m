...
static const char showIndicator;
...
{
    objc_setAssociatedObject(self, &showIndicator, @(showIndicatorView), OBJC_ASSOCIATION_ASSIGN);
}

#pragma mark get Mettod

- (BOOL)isShowIndicatorView
{
    id tmp = objc_getAssociatedObject(self, &showIndicator);
    NSNumber *number = tmp;
...
//    NSLog(@"number --------->> %lu",(unsigned long)number.unsignedIntegerValue);
